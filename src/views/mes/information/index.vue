  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="设备状态" prop="deviceStatus">
        <el-select v-model="queryParams.deviceStatus" placeholder="请选择设备状态" clearable>
          <el-option
            v-for="dict in dict.type.mes_device_status"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="编码" prop="deviceCode">
          <el-input v-model="form.deviceCode" placeholder="请输入编码" />
        </el-form-item>
        <el-form-item label="型号" prop="deviceModel">
...
<script>
import { listInformation, getInformation, delInformation, addInformation, updateInformation } from "@/api/mes/information";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('mes/information/export', {
        ...this.queryParams
